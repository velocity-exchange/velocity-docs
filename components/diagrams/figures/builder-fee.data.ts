...
// per order, so the 70/30 split is illustrative, not to scale.
export const builderFeeSpec: SankeySpec = {
  ...
  links: [
    { from: "payment", to: "taker_fee", value: 70, label: "The normal tiered taker fee, unaffected by the builder fee" },
    {
      from: "payment",
      to: "builder_fee",
      value: 30,
