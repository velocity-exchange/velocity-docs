...
export const feeFlowSpec: SankeySpec = {
  nodes: [
    ...
    { id: "maker", label: "Maker rebate", value: "4.5–12.5%", column: 1, tone: "out" },
    ...
    { id: "if", label: "Insurance Fund", value: "≈11%", note: "15% of net", column: 2 },
    { id: "vamm", label: "vAMM capital", value: "≈11%", note: "15% of net", column: 2 },
  ...
  links: [
    ...
    { from: "gross", to: "maker", value: 8.5, tone: "out", label: "Maker rebate: 4.5 to 12.5% of the gross taker fee, drawn at 8.5%" },
