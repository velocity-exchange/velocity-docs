...
The AMM has protections in place to prevent the long short imbalance from skewing too heavily to either side. More information on that is here at: [Velocity AMM](/protocol/about-v3/drift-amm). Despite these protections, there is still a risk that the AMM will be exposed to delta risk in periods of significant volatility.
