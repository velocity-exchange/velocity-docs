...
JIT Proxy Address: J1TnP8zvVxbtF5KFp5xRmWuvG9McnhzmBd9XGfCyuxFP (Drift's mainnet jit-proxy program — Velocity's deployed address is unconfirmed; see open questions)
...
You can read docs here ([Matching Engine](/protocol/how-it-works/matching-engine)) as well as read through an example trading bot ().  
