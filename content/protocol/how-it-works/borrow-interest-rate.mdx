...
Velocity's lending pools use a borrow interest rate model inspired by [Aave](https://aave.com/docs/aave-v3/smart-contracts/interest-rate-strategy). 
...
---
_The multi-kink model and segment weights above have not changed since launch._
