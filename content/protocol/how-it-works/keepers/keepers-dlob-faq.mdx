...
-   against each other when their prices cross, executed at the resting maker order's price;
...
Incentive structures are listed in <a href="/protocol/how-it-works/keepers/keeper-incentives">Keeper Incentives</a>.
