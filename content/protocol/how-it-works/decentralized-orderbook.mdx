...
Velocity's decentralised orderbook is powered by our network of [Keeper Bots](/protocol/how-it-works/keepers). 
...
2. Maker orders that fill against the AMM are still eligible for the maker rebate.
