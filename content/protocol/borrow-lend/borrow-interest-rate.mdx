...
Velocity's lending pools use a borrow interest rate model inspired by [Aave](https://docs.aave.com/risk/liquidity-risk/borrow-interest-rate). 
...
<div style={{ margin: '1.5rem 0' }}>
  <img src="/assets/sol_interest_curve.png" alt="Borrow Interest Rate Curve for SOL" />
</div>
...
---
_The multi-kink model and segment weights above are unchanged from the pre-fork Drift Protocol v2 codebase._
