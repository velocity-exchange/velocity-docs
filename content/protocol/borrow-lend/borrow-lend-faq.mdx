...
*   ~87% initial, ~91% maintenance. LTV limits change as market parameters are updated; see the live table in [Cross-Collateral Deposits](/protocol/getting-started/cross-collateral-deposits).
