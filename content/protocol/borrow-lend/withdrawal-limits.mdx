...
**Maximum borrows.** The ceiling on borrows depends on whether the market is the main pool or an [isolated pool](/protocol/how-it-works/isolated-pools), since isolated pools are tuned to tolerate materially higher utilization:
