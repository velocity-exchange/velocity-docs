...
| Fill | The midpoint of the scaled initial weight and the maintenance weight | Matching an order that is already resting. |
...
The Fill weight sits in the middle of that band on purpose. Without it, an order that was legal when you placed it could leave you immediately liquidatable the moment it fills.
...
For the same 1,000 SOL at $200, your maintenance collateral is `$200,000 * 0.90 = $180,000`. That is the figure compared against your maintenance margin requirement.
...
**Opening.** Your initial collateral is `$200,000 * 0.80 = $160,000`. At a 10% initial margin ratio you can open $1.6M of SOL-PERP long.
