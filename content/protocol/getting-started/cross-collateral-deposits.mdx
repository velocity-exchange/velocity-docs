...
> For instance, depositing USDT gives users a 1:1 margin for derivatives trading, but depositing SOL (80% asset weight) means that 80% of the value of your SOL at the opening of your position will be available as margin for perpetual futures trading.
...
`Initial Asset Weight` on 2000 SOL Collateral, using SOL's IMF factor of 0.00125, would be:

`weight = min (.80, 1.1 / [ 1 + (0.00125 * sqrt(2000)] )`
