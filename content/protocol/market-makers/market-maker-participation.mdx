...
Makers can also provide liquidity to Drift's decentralised orderbook by quoting via the UI or programmatically through the [SDK Documentation](/developers/sdk-documentation)  
...
Floating Maker Bot - Github Link: [https://github.com/velocity-exchange/keeper-bots-v2/blob/master/src/bots/floatingMaker.ts](https://github.com/velocity-exchange/keeper-bots-v2/blob/master/src/bots/floatingMaker.ts)