...
These orders take against the AMM and are executed by a decentralised network of keepers, see [Decentralised Orderbook FAQ](/protocol/how-it-works/keepers/keepers-dlob-faq), once certain conditions are met (i.e. the mark price crosses the specified trigger/limit price).
