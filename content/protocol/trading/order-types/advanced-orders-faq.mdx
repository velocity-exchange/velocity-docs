...
See [Trigger Market vs. Trigger Limit](/protocol/trading/order-types/advanced-order-types) for how the two activate and fill.
...
See [Order flags](/protocol/trading/order-types/advanced-order-types#order-flags) for the reduce-only definition.
