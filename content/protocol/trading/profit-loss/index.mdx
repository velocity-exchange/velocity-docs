...
Once settled, your P&L becomes available for **withdrawal** from the [P&L pool](/protocol/how-it-works/profit-loss-pool) if the pool has enough funds. If not, you might need to wait for others to settle their losses before you can withdraw your profits.
</Steps>
...
1. On any [trades screen](https://velocity.exchange) navigate to the "Balances" tab.
