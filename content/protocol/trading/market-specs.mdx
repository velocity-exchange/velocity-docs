...
Each market's current Contract Tier assignment can change over time as risk parameters are reviewed; the authoritative value for a given market is shown in-app and on-chain.
