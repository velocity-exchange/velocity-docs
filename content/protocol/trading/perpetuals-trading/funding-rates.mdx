...
Note: this dead zone can also be delayed at large oracle divergences (see [Oracles](/protocol/how-it-works/oracles)). Individual Market TWAP updates utilize the side of the book for trade executions, Bid and Ask TWAPs in the market are calculated and/or estimated on every trade.
</Callout>
