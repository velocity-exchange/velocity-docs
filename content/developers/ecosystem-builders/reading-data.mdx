...
<Callout type="info">
Velocity's hosted Data API is live at `data.velocity.exchange`. The examples below use that host. See [Data API](/developers/data-api).
</Callout>

- Base URL: `https://data.velocity.exchange`
...
- **DLOB server** (`https://dlob.velocity.exchange`): Orderbook snapshots and streaming. See [Orderbook + DLOB websocket](/developers/ecosystem-builders/orderbook-and-ws).
