...
| ~~periodRevenue~~              | int  |           | **Removed on Velocity.** The onchain `FundingRateRecord` no longer carries this field. |
| baseAssetAmountWithAmm         | int  |           | Total base asset in the AMM pool.             |
| ~~baseAssetAmountWithUnsettledLp~~ | int  |           | **Removed on Velocity.** vAMM LP shares were removed, and the onchain `FundingRateRecord` no longer carries this field. |
