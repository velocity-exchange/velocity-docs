---
title: "Quickstart: Create and Run a Vault"
---
...
After creation the manager can lower fees, shorten the redeem period, or adjust caps immediately (within the one-way constraints described in [Vault Managers](/developers/vault-managers)):
