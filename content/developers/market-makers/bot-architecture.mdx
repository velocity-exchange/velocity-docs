...
Production market making bots need more than just order placement logic. This page covers the infrastructure patterns used across Drift's [keeper-bots-v2](https://github.com/velocity-exchange/keeper-bots-v2), applicable to market making, filling, and triggering bots.
...
The [`JitMaker`](https://github.com/velocity-exchange/keeper-bots-v2/blob/master/src/bots/jitMaker.ts) enforces a 1:1 subaccount-to-market ratio and throws if the mapping isn't configured correctly.
...
See [keeper-bots-v2](https://github.com/velocity-exchange/keeper-bots-v2) for the reference implementation of these patterns. Key files:
- [`floatingMaker.ts`](https://github.com/velocity-exchange/keeper-bots-v2/blob/master/src/bots/floatingMaker.ts): mutex guards, slot-based cooldowns, watchdog timer
- [`jitMaker.ts`](https://github.com/velocity-exchange/keeper-bots-v2/blob/master/src/bots/jitMaker.ts): subaccount isolation, DLOB integration, volatility checks
- [`utils.ts`](https://github.com/velocity-exchange/keeper-bots-v2/blob/master/src/utils.ts): throttling, market type conversion, volatility detection helpers
