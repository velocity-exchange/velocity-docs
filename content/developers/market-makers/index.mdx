...
| Bot | Source | Strategy |
|---|---|---|
| **FloatingPerpMaker** | [`src/bots/floatingMaker.ts`](https://github.com/velocity-exchange/velocity-v1/blob/master/apps/keeper-bots-v2/src/bots/floatingMaker.ts) | Oracle offset resting orders on DLOB |
