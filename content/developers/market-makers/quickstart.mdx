...
- Funded Solana account with collateral (dUSDT on devnet; USDT on mainnet)
...
- [keeper-bots-v2 `FloatingPerpMaker`](https://github.com/velocity-exchange/velocity-v1/blob/master/apps/keeper-bots-v2/src/bots/floatingMaker.ts) - production reference for oracle offset quoting
