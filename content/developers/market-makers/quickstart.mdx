...
- [keeper-bots-v2 `FloatingPerpMaker`](https://github.com/velocity-exchange/protocol-v2/blob/master/apps/keeper-bots-v2/src/bots/floatingMaker.ts) - production reference for oracle offset quoting
