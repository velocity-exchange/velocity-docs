...
## "ExchangePaused" or "MarketFillOrderPaused" errors

These are operational pauses, not bugs in your bot, and retrying will not clear them.
...
The full bit-by-bit matrix, including which error each pause raises, is in [Block Conditions](/protocol/risk-and-safety/block-conditions#pause-and-market-status-gating).
