...
The reference implementation for keeper bots is [`apps/keeper-bots-v2`](https://github.com/velocity-exchange/velocity-v1/tree/master/apps/keeper-bots-v2) in the velocity-v1 monorepo, and most examples below follow that app's config + entrypoint pattern.
