...
Market orders go through [Just-In-Time (JIT) Auctions](/protocol/how-it-works/matching-engine) where Makers fight to fill orders before the order is allowed to fill against the Velocity AMM.
